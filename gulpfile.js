...
gulp.task("copyfiles", function() {
	...
	// Copy tinymce
	gulp.src("vendor/bower_dl/tinymce/tinymce.min.js")
        .pipe(gulp.dest("public/assets/tinymce/"));
	
	gulp.src("vendor/bower_dl/tinymce/plugins/**/*")
		.pipe(gulp.dest("public/assets/tinymce/plugins/"));

	gulp.src("vendor/bower_dl/tinymce/themes/**/*")
		.pipe(gulp.dest("public/assets/tinymce/themes/"));
		
	gulp.src("vendor/bower_dl/tinymce/skins/***/**/*")
		.pipe(gulp.dest("public/assets/tinymce/skins/"));
